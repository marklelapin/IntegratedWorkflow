...
namespace IntegratedWorkflowLibrary.Models
{
    public class AccessRuleModel
    {
        ...
        /// </summary>
        public string AccessEntityID { get; set; }
        /// <summary>
        /// The Name of the particular group, person or job title etc to determine access from
        /// </summary>
        public string AccessEntityName { get; set; }
        /// <summary>
        ...
        public string DisplayName
        {
            ...
            get
            {
               return $"{AccessEntityTypeTitle}, {AccessEntityName}: {AccessTypeTitle}"; 
            }
            
        }
            
        
        //public AccessRuleModel(AccessTypeModel accessType,AccessEntityTypeModel accessEntityType, AccessEntityModel accessEntity)
        //    {
        //    AccessTypeID = accessType.ID;
        //    AccessTypeTitle = accessType.Title;
        //    AccessEntityTypeID = accessEntityType.ID;
        //    AccessEntityTypeTitle = accessEntityType.Title;
        //    AccessEntityID = accessEntity.ID;
        //    AccessEntityName = accessEntity.Name;
        //}
